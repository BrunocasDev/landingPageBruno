                ...
                <div class="form">
                    <div class="info-box">
                        ...
                        <form class="form-info">
                            ...
                            <div class="mb-2">
                                <input type="text" class="form-control" placeholder="Concelho de Residência"
                                    required />
                            </div>
                            <div class="mb-2">
                            ...
                            <div class="mb-2 text-black">
                                ...
                                <label for="privacy-checkbox">
                                    Li e aceito a
                                    <a href="#" id="privacy-link" class="text-black">Política de Privacidade</a>
                                </label>
                            </div>
                ...
                <div class="col-md-6 for-whom-info">
                    ...
                    <ul class="list-unstyled custom-list">
                        ...
                        <li>
                            ...
                            <span class="highlight">profissionais que precisam melhorar o inglês para fins
                                académicos ou profissionais</span>
                        </li>
